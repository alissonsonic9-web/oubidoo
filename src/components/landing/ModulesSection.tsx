          ...
          {modulesData.map((module) => {
            ...
            return (
              <Card key={module.id} className="flex flex-col overflow-hidden shadow-lg hover:shadow-xl transition-shadow duration-300 bg-card">
                ...
                <CardHeader>
                  <CardTitle className="text-xl font-bold text-primary min-h-[3.5rem] uppercase">{module.title}</CardTitle>
                </CardHeader>
                  ...
                  <ul className="space-y-2">
                    {module.description.map((point, index) => (
                      <li key={index} className="flex items-start">
                        ...
                        <span className="text-2xl text-foreground/80 font-inter font-bold">{point}</span>
                      </li>
                    ))}
                  </ul>
                </CardContent>
